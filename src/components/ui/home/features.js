...
const FeaturesPage = () => {
  return (
    <div className='flex flex-col items-center md:items-start justify-center md:justify-start lg:p-12 p-8 w-full'>
      <Card className='flex flex-col items-center justify-center rounded-3xl border-blue-300 bg-[#f9fbff] gap-4 lg:p-12 p-6 w-[30%] '>
        <div className='flex flex-col w-full h-[480px] lg:items-start '>
          <div className='flex flex-col items-start gap-4 lg:px-3 mt-3'>
            <p className='lg:text-[11.6px] text-sm font-semibold  text-[#000d49] w-full'>
              Enter your story topic
            </p>
            <div className='flex flex-col  w-full  relative'>
              <div className='absolute bg-white top-0  h-[37px] w-[378px] rounded-full  '>
                <div className='top-[12px] left-[16px] absolute'>
                  ...
                  <div className='flex flex-col items-start justify-start'>
                    ...
                    <div className='relative h-[37px] w-[378px]'>
                      <div className='absolute h-[37px] w-[378px] rounded-full border-[#e1ebff]  top-[0px] bg-white'>
                        ...
                        <div className='relative h-[37px] w-[378px]'>
                          <div className='absolute border-[#e1ebff] w-[378px] h-[37px] rounded-full'>
                  ...
                  <div className='flex flex-col items-strart justify-start gap-4'>
                    <p className='text-[18px] text-[#000d4980]'>1- </p>
                  </div>
                  <div className='flex flex-col items-start justify-start'>
                    <h3 className='text-[#000d49] text-[17px] font-normal'>
                      Write and outline
                    </h3>
                    <p className='text-[15px] text-[#000d49]'>
