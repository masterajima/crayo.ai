...
const Hero = ({}) => {
  return (
    <div className='bg-white'>
      <div className='relative flex flex-col overflow-hidden rounded-[20px] bg-[url("/")] bg-cover bg-center transition-opacity duration-1000 ease-in-out opacity-100 md:m-5 md:rounded-[40px]'>
        <div className='flex flex-grow items-center justify-center '>
          <main className='align-center container space-y-8 items-center mx-auto px-4 py-8 md:space-y-10'>
            ...
            <div className='mx-auto max-w-3xl space-y-2 md:space-y-4'>
              ...
              <p className='text-md mb-8 md:text-3xl'>
                Your all-in-one tool for creating AI voice overs, engaging subtitles,
                optimized game play, and more.
              </p>
            </div>
            <Link
              href='/'
            ...
            <div className='mt-8 pb-24'>
              ...
              <div className='align-center flex justify-center space-x-4 md:space-x-8'>
                <Image
                  src='/assets/images/hero-tiktok.png'
                  alt='tiktok'
                  width={110}
                  height={48}
